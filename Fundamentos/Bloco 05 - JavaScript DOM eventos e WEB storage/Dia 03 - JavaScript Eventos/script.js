function createDaysOfTheWeek() {
  ...
  function dayCalendar() {
    let classeDay = document.querySelector('#days');
  ...
  function creatHolidayButton(buttonName) {  
...
function creatFridayButton(buttonFriday) {  
